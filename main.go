...
// [[ ! -f ${FILE} ]] && { /usr/bin/printf "[ x ] \t${FILE} doesnt exist"; curl -Lks https://github.com/nberlee/talos/releafor i in ${CLUSTER_NODES[@]}; do
